                    ...
                    <div class="input-box">
                        <div class="input">
                            <select id="home-pages" name="home_page">
                                ...
                                <option value="//transvelo.github.io/techmarket-html/landing-page-v1.html">Landing v1</option>
                                <option value="//transvelo.github.io/techmarket-html/landing-page-v2.html">Landing v2</option>
                                ...
                                <option value="//transvelo.github.io/techmarket-html/terms-and-conditions.html">Terms and Conditions</option>
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select id="demo-pages" name="demo-shop">
                                ...
                                <option value="//transvelo.github.io/techmarket-html/login-and-register.html">My Account</option>
                                ...
                                <option value="//transvelo.github.io/techmarket-html/track-your-order.html">Track Your Order</option>
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select id="header-style" name="header">
                                ...
                                <option value="//transvelo.github.io/techmarket-html/blog-fullwidth.html">Blog Fullwidth</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select id="shop-style" name="shop-style">
                                <option value="">Choose</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-extended.html">Shop Extended</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-fullwidth.html">Shop Fullwidth</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-listing.html">Shop Listing</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-listing-large.html">Shop Listing Large</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-listing-with-product-sidebar.html">Shop Listing with Product Sidebar</option>
                                <option value="//transvelo.github.io/techmarket-html/shop-right-sidebar.html">Shop Right Sidebar</option>
                                <option value="//transvelo.github.io/techmarket-html/product-category.html">Product Category</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="input-box">
                        <div class="input">
                            <select id="single-products" name="single-product">
                                <option value="">Choose</option>
                                <option value="//transvelo.github.io/techmarket-html/single-product-sidebar.html">Single Product Sidebar</option>
                                <option value="//transvelo.github.io/techmarket-html/single-product-fullwidth.html">Single Product Fullwidth</option>
                                <option value="//transvelo.github.io/techmarket-html/single-product-ectended.html">Single Product Extended</option>
                            </select>
                        </div>
                    </div>
...
import VHeader from './template/component/header.vue';
import featured from './template/component/featured.vue';
import aboutfeatures from './template/component/about-features.vue';
import teammember from './template/component/team-member.vue';
import accordion from './template/component/accordion.vue';
import beforefooter from './template/component/footer/before-footer.vue';
import footerwidgets from './template/component/footer/footer-widgets.vue';
import copywrite from './template/component/footer/copywrite.vue';
